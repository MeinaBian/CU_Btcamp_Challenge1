#ALL ANSWER IS BELOW THE COMMENT "ANSWER"
...
#calculate the new loan present value by the function created
new_loan_present_value = calculate_present_value(future_value,remaining_months,annual_discount_rate)
...
# ANSWER
for item in loans:
    if item["loan_price"] > 500: # the item is the current dictionary selected from the list. Then we can access elements inside the dictionary using the key "loan price"
